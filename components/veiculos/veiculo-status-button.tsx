...
import { alterarStatusVeiculo } from "@/actions/veiculos/alterar-status-veiculo";
...
export function VeiculoStatusButton({
  empresaId,
  veiculoId,
  placa,
  ativo,
  ...
  async function handleAlterarStatus() {
    ...
    try {
      ...
      setErro(
        "Não foi possível alterar o status do veículo. Tente novamente."
      );
    } finally {
      setCarregando(false);
    }
