...
import { alterarStatusMotorista } from "@/actions/motoristas/alterar-status-motorista";
...
export function MotoristaStatusButton({
  empresaId,
  motoristaId,
  motoristaNome,
  ativo,
  ...
  async function handleAlterarStatus() {
    ...
    try {
      ...
      setErro(
        "Não foi possível alterar o status do motorista. Tente novamente."
      );
    } finally {
      setCarregando(false);
    }
          ...
          {vaiAtivar ? (
            <>
              <p className="font-medium text-emerald-700 dark:text-emerald-400">
                O motorista voltará a ficar
                disponível.
              </p>

              <p className="mt-1 text-muted-foreground">
                Ele poderá ser selecionado
                novamente em novas
