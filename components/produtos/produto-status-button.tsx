...
import { alterarStatusProduto } from "@/actions/produtos/alterar-status-produto";
...
export function ProdutoStatusButton({
  empresaId,
  produtoId,
  produtoDescricao,
  ativo,
  ...
  async function handleAlterarStatus() {
    ...
    try {
      ...
      setErro(
        "Não foi possível alterar o status do produto. Tente novamente."
      );
    } finally {
      setCarregando(false);
    }
          ...
          {vaiAtivar ? (
            <>
              <p className="font-medium text-emerald-700 dark:text-emerald-400">
                O cadastro voltará a ficar
                disponível.
              </p>

              <p className="mt-1 text-muted-foreground">
                O produto ou serviço poderá
                ser utilizado novamente em
                novas operações e notas
                fiscais.
              </p>
            </>
          ) : (
            <>
              ...
              <p className="mt-1 text-muted-foreground">
                O produto ou serviço deixará
                de ficar disponível para
                novas operações, mas
                continuará vinculado aos
