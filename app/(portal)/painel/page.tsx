...
const opcoes = [
  {
    ...
    descricao:
      "Cadastre empresas, consulte os dados cadastrais e escolha o ambiente em que deseja trabalhar.",
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-3 max-w-xl text-sm leading-6 text-muted-foreground sm:text-base">
                Gerencie suas empresas e
                organize os usuários que
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm leading-6 text-muted-foreground">
              ...
              Depois, acesse o ambiente dela
              para gerenciar clientes,
              produtos, configurações fiscais
              e notas.
            </p>
          </div>
        </div>
